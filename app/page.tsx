  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-x-hidden">
        ...
        {/* ✅ HERO SECTION OTIMIZADA PARA BELEZA */}
        <section ref={heroRef} className="relative min-h-screen flex items-center justify-center px-2 py-4">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 to-blue-900/20"></div>
          
          <div className="glass-beauty-hero max-w-5xl mx-auto relative z-10 beauty-fade-in">
            
            {/* ✅ PROVA SOCIAL MELHORADA */}
            <div className="flex flex-wrap justify-center gap-2 mb-3">
              <Badge className="beauty-social-proof text-xs">
            ...
            {/* ✅ HEADLINE FEMININA PREMIUM */}
            <h1 className="beauty-headline-mobile">
            ...
            {/* ✅ SUBHEADLINE FEMININA */}
            <p className="beauty-subtitle-mobile">
            ...
            <div className="relative max-w-3xl mx-auto mb-4">
              <Card className="glass-beauty-card p-2">
            ...
            {/* ✅ CTA PRINCIPAL FEMININO */}
            <div className="text-center mb-3">
              <Button 
                onClick={(e) => handleCTA(e, 'hero')}
                disabled={isLoading}
                className="btn-beauty-primary beauty-gpu-accelerated"
                aria-label="Garantir minha vaga por R$ 37 antes que o preço volte para R$ 297"
              >
                {isLoading ? (
                  <span className="flex items-center justify-center">
                    PROCESSANDO
                    <div className="beauty-loading-dots">
                      <div className="beauty-loading-dot"></div>
                      <div className="beauty-loading-dot"></div>
                      <div className="beauty-loading-dot"></div>
                    </div>
                  </span>
            ...
            {/* ✅ TIMER FEMININO ELEGANTE */}
            <div className="beauty-timer-compact max-w-xs mx-auto">
              ...
              <div className="flex justify-center gap-2" role="timer" aria-live="polite" aria-label={`Tempo restante: ${timeLeft.hours} horas, ${timeLeft.minutes} minutos, ${timeLeft.seconds} segundos`}>
                <div className="text-center">
                  <div className="beauty-timer-digit">{String(timeLeft.hours).padStart(2, '0')}</div>
                  <div className="text-xs text-red-300">H</div>
                </div>
                <div className="beauty-timer-digit">:</div>
                <div className="text-center">
                  <div className="beauty-timer-digit">{String(timeLeft.minutes).padStart(2, '0')}</div>
                  <div className="text-xs text-red-300">M</div>
                </div>
                <div className="beauty-timer-digit">:</div>
                <div className="text-center">
                  <div className="beauty-timer-digit">{String(timeLeft.seconds).padStart(2, '0')}</div>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-3 mt-6">
              <Card className="glass-beauty-card p-3 hover:scale-105 transition-transform duration-300">
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="beauty-calculator max-w-lg mx-auto">
              <h3 className="text-lg font-bold mb-3 text-white text-center">RENDA MENSAL REAL:</h3>
              
              <div className="beauty-earning-row">
                <span>1 cliente/dia</span>
                <span className="beauty-earning-value">R$ 1.210</span>
              </div>
              
              <div className="beauty-earning-row bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-400">
                <span>2 clientes/dia (META REAL)</span>
                <span className="beauty-earning-value text-xl">R$ 2.420</span>
              </div>
              
              <div className="beauty-earning-row">
                <span>3 clientes/dia</span>
                <span className="beauty-earning-value">R$ 3.630</span>
              </div>
        ...
        <section ref={priceRef} className="py-12 px-4">
          <div className="max-w-3xl mx-auto">
            <div className="beauty-price-section relative z-10">
              <div className="relative z-20">
                ...
                <Card className="glass-beauty-card p-3 border-2 border-amber-400 mb-4">
                  <CardContent className="p-0">
                ...
                <div className="text-center mb-4">
                  <div className="beauty-price-old">De R$ 297,00</div>
                  <div className="beauty-price-new">R$ 37</div>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="glass-beauty-card p-4">
              <CardContent className="p-0">
                <div className="text-center mb-4">
                  <Image
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              {[
                ...
                <Card key={filename} className="glass-beauty-card p-1 hover:scale-105 transition-transform duration-300">
                  <Image
        ...
        {/* ✅ DEPOIMENTOS FEMININOS ELEGANTES */}
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="beauty-section-title">
            ...
            <div className="space-y-3">
              <Card className="beauty-testimonial hover:scale-105 transition-transform duration-300">
                <CardContent className="p-0">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <p className="beauty-testimonial-text">
                      ...
                      <p className="beauty-testimonial-author">Mariana Silva, SP</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="beauty-testimonial-author">Juliana Costa, RJ</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="beauty-testimonial-author">Fernanda Oliveira, MG</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="p-0">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="beauty-testimonial-author">Carolina Santos, PR</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid gap-3">
              ...
              <Card className="glass-beauty-card p-3 border-2 border-amber-400 hover:scale-105 transition-transform duration-300">
                <CardContent className="p-0">
                  <div className="flex items-center mb-2">
              ...
              <Card className="glass-beauty-card p-4">
                <CardContent className="p-0 text-center">
                  ...
                  <Button 
                    ...
                    disabled={isLoading}
                    className="btn-beauty-primary w-full mb-3"
                  >
                    {isLoading ? (
                      <span className="flex items-center justify-center">
                        PROCESSANDO
        ...
        <section className="py-12 px-4">
          <div className="max-w-3xl mx-auto">
            <Card className="glass-beauty-card p-4 text-center hover:scale-105 transition-transform duration-300">
              <CardContent className="p-0">
        ...
        <section className="py-12 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Accordion type="single" collapsible className="space-y-3">
              <AccordionItem value="item-1" className="glass-beauty-card border-none">
              ...
              <AccordionItem value="item-2" className="glass-beauty-card border-none">
                <AccordionTrigger className="text-white hover:text-amber-400 px-3 text-sm">
              ...
              <AccordionItem value="item-3" className="glass-beauty-card border-none">
                <AccordionTrigger className="text-white hover:text-amber-400 px-3 text-sm">
              ...
              <AccordionItem value="item-4" className="glass-beauty-card border-none">
                <AccordionTrigger className="text-white hover:text-amber-400 px-3 text-sm">
              ...
              <AccordionItem value="item-5" className="glass-beauty-card border-none">
                <AccordionTrigger className="text-white hover:text-amber-400 px-3 text-sm">
        ...
        <section className="py-12 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button 
              ...
              disabled={isLoading}
              className="btn-beauty-primary text-base py-4 px-6 beauty-gpu-accelerated mb-3"
